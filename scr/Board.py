...
from fields.EmptyField import EmptyField
from fields.TrainField import TrainField
...
class Board:
    def __init__(self):
        ...
        self.fields[5].add_information("Reading Railroad", 200, (25, 50, 100, 200), "\\Streets\\Reading Railroad.PNG")
